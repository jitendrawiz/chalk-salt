...
define([ 'angular', 'text!../templates/studentProfile.tpl.html', 'text!../templates/studentHome.tpl.html', 'text!../templates/adminProfile.tpl.html',
    ...
    'text!../templates/exam/testScreenPage.tpl.html','text!../templates/exam/testGroupPage.tpl.html','text!../templates/exam/testSubjectivePaper.tpl.html'], function(angular, templateHome, templateProfile, adminprofiletemplate, adminhometemplate, studentdetailstemplate,
    examQuestionMasterTemplate, examQuestionListTemplate, testInstructionTemplate, notesTemplate, testScreenTemplate,testGroupTemplate,templateSubjectivePaper) {
  ...
  homeRouter.config([ '$stateProvider', function($stateProvider) {
    ...
    }).state('chalkanddust.subjectivePaper', {
      url : '/student/subjectivePapers',
      template : templateSubjectivePaper,
      controller : 'StudentController as stdCtrl'
    });
  } ]);
});