...
public enum ErrorCode {
	...
	/** The fail to fetch schedule test list. */
	FAIL_TO_FETCH_SCHEDULE_TEST_LIST(1064),

	/** The fail to fetch schedule test data. */
	FAIL_TO_FETCH_SCHEDULE_TEST_DATA(1065),

	/** The fail to update schedule test data. */
